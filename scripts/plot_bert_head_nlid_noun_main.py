#!/usr/bin/env python3
"""Regenerate the main BERT/NOUN head-distance Nonlinear ID plot."""
...
TABLE_PATH = (
    ...
    / "all"
    / "noun"
    / "headdist_NOUN_gride_bert-base-uncased_first.csv"
)
OUT_PATH = ROOT / "plots_main" / "plots_features" / "bert_head_NLID_NOUN.pdf"
...
def main() -> None:
    ...
    ax.set_xlabel("Layer", fontsize=24, labelpad=8)
    ax.set_ylabel("Nonlinear ID")
