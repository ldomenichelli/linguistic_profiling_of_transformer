#!/usr/bin/env python3
"""Regenerate the main BERT/NOUN head-distance IsoScore plot."""
...
TABLE_PATH = (
    ...
    / "all"
    / "noun"
    / "headdist_NOUN_iso_bert-base-uncased_first.csv"
)
OUT_PATH = ROOT / "plots_main" / "plots_features" / "bert_head_iso_NOUN.pdf"
...
def main() -> None:
    ...
    ax.set_title("BERT", fontsize=30, pad=10)
